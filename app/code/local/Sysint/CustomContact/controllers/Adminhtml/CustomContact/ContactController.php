 ...
 */
class Sysint_CustomContact_Adminhtml_CustomContact_ContactController
    extends Mage_Adminhtml_Controller_Action
{
    ...
    public function newAction()
    {
        $this->loadLayout();
        $this->renderLayout();
        Mage::getSingleton('adminhtml/session')->setData('contact_data', null);
    }
    ...
    public function saveAction()
    {
        ...
        if (!empty($data)) {
            try{
                ...
                Mage::getSingleton('adminhtml/session')->setData('contact_data', $data);
                Mage::logException($e);
    ...
    {
        $ids = $this->getRequest()->getParam('contact_ids');
        if (!is_array($ids)) {
